<%@ Page Title="xsdan" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.cccc.xsdan.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="dunw" HeaderText="dunw" SortExpression="dunw" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="danw" HeaderText="danw" SortExpression="danw" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="skjine" HeaderText="skjine" SortExpression="skjine" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ye" HeaderText="ye" SortExpression="ye" ItemStyle-HorizontalAlign="Center"  /> 
