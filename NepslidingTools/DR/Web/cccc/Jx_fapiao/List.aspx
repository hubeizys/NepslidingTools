<%@ Page Title="Jx_fapiao" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.cccc.Jx_fapiao.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="cgdbhao" HeaderText="cgdbhao" SortExpression="cgdbhao" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="kaipr" HeaderText="kaipr" SortExpression="kaipr" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="fpneixing" HeaderText="fpneixing" SortExpression="fpneixing" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="jbanr" HeaderText="jbanr" SortExpression="jbanr" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="cal" HeaderText="cal" SortExpression="cal" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="fphao" HeaderText="fphao" SortExpression="fphao" ItemStyle-HorizontalAlign="Center"  /> 
