...
namespace Maticsoft.DAL.cccc
{
	...
	public partial class danweixinxi
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "danweixinxi"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from danweixinxi");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from danweixinxi ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,danwei ");
			strSql.Append(" FROM danweixinxi ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from danweixinxi T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "danweixinxi";
