...
namespace Maticsoft.BLL
{
    ...
    {
        private readonly Maticsoft.DAL.port dal = new Maticsoft.DAL.port();
        public port()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        public Maticsoft.Model.port GetModelByCache(string mac)
        {
            ...
            return (Maticsoft.Model.port)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Maticsoft.Model.port> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Maticsoft.Model.port> DataTableToList(DataTable dt)
        {
            List<Maticsoft.Model.port> modelList = new List<Maticsoft.Model.port>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Maticsoft.Model.port model;
