...
namespace Maticsoft.DAL.cccc
{
	...
	public partial class skdan
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "skdan"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from skdan");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Maticsoft.Model.cccc.skdan model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into skdan(");
			strSql.Append("skfs,skjine,dxjine,beizhu,fkdw,jsr,djbh,shijian)");
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@fkdw", MySqlDbType.VarChar,64),
			...
			parameters[0].Value = model.skfs;
			parameters[1].Value = model.skjine;
			parameters[2].Value = model.dxjine;
			parameters[3].Value = model.beizhu;
			parameters[4].Value = model.fkdw;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.cccc.skdan model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update skdan set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from skdan ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.cccc.skdan GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,skfs,skjine,dxjine,beizhu,fkdw,jsr,djbh,shijian from skdan ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.cccc.skdan DataRowToModel(DataRow row)
		{
			Maticsoft.Model.cccc.skdan model=new Maticsoft.Model.cccc.skdan();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,skfs,skjine,dxjine,beizhu,fkdw,jsr,djbh,shijian ");
			strSql.Append(" FROM skdan ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from skdan T ");
