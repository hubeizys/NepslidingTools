...
namespace Maticsoft.DAL
{
	...
	public partial class measures
	{
		...
		public bool Add(Maticsoft.Model.measures model)
		{
			...
			strSql.Append("step,Tools,position,standardv,up,down,PN,CC)");
		...
		public Maticsoft.Model.measures GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,step,Tools,position,standardv,up,down,PN,CC from measures ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,step,Tools,position,standardv,up,down,PN,CC ");
